...
<body class="dark-mode"> <!-- Mặc định là dark mode -->
    ...
    <main class="container">
        <br><br><br><br><h1><?php echo htmlspecialchars($storyName); ?> - Chapter <?php echo htmlspecialchars($chapterName); ?> <?php echo $chapterTitle ? ' - ' . htmlspecialchars($chapterTitle) : ''; ?></h1>
