...
<head>
    ...
    <link rel="stylesheet" href="../css/main.css"> <!-- Sử dụng main.css thay vì style riêng -->
</head>
<body>
    <?php include '../includes/header.php' ?>
    <div class="container mt-4">
        <div class="section-wrapper">
            <h4 class="section-title"><i class="fas fa-clock"></i> Danh Sách Truyện - Sắp Ra Mắt</h4>
            <div class="row g-3">
                            ...
                            <div class="manga-card">
                                ...
                                <div class="card-body p-2">
                                    ...
                                    <div class="text-muted small d-flex justify-content-between align-items-center mt-1">
                                        ...
                                        <span><i class="fas fa-clock"></i> <?= formatDate(isset($truyen['updatedAt']) ? $truyen['updatedAt'] : null) ?></span>
                                    </div>
